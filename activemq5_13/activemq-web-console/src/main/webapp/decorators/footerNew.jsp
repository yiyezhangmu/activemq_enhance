                                        ...
                                        <div class="navigation_top">
                                            <div class="navigation_bottom">
                                                ...
                                                <ul class="alternate" type="square">
                                                    ...
                                                    <li><a href="queueStatisticsGraph.jsp?JMSDestination=${requestContext.queueStatisticsQuery.JMSDestination}" title="View the queue depths as a graph">Graph</a></li>
